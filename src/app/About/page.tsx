    ...
    <>
      <section className={styles.about} data-aos="fade-down">
        <div className={styles.title}>
          <h1>
            Jovens, transparentes e <br /> orientados para resultados.
          </h1>
          <p>
            Como dizia Steve Jobs: os loucos que acham que podem mudar o mundo,
            são os que efetivamente o fazem. Não sei o quanto vamos mudar o
            mundo, mas estamos aqui para mudar o Brasil, uma empresa de cada
            vez.
          </p>
        </div>
